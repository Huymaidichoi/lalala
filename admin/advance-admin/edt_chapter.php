                    ...
                    <div>
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <a href="list_chapter.php?idChapter=<?php echo $_GET['idChapter'] ?>">Hủy bỏ</a>
                            </div>
                            <div class="panel-body">
                                <?php
                                $getchap = $getdata->getChapter($_GET['idChapter']); foreach ($getchap as $chap)
                                ?>
                                <form role="form" method="POST">
                                    <div class="form-group">
                                        <label>Tên: <input class="form-control" type="text" name="name"
                                                value="<?php echo $chap['name'] ?>"></label>
                                    </div>
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    if (empty($name)) {
                                        ...
                                        $inchap = $getdata->up_chap($_GET['idChapter'], $name);
                                        if ($inchap) {
                                            // echo "Success";
