                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php foreach ($select as $se_pro) //Duyệt data trả về từ database
                                            {
                                                ?>
                                                <tr>
                                                    <td>
                                                        <?php echo $se_pro['id_user'] ?>
                                                    </td>
                                                    <td>
                                                        <img style="max-width: 100px;"
                                                            src="IMG/avatar/<?php echo $se_pro['avatar'] ?>">
                                                    </td>
                                                    <td>
                                                        <?php echo $se_pro['name_user'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $se_pro['email'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $se_pro['password'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $se_pro['permission'] ?>
                                                    </td>
                                                    <td><a
                                                            href="edt_info_user.php?idUser=<?php echo $se_pro['id_user'] ?>">Sửa</a>
                                                    </td>
                                                    <td><a
                                                            href="dlt_info_user.php?idUser=<?php echo $se_pro['id_user'] ?>">Xóa</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
